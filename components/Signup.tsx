        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-2 gap-4">
              ...
              <img src="https://picsum.photos/seed/nature/400/520" alt="Organic product" className="rounded-2xl shadow-xl object-cover w-full h-full" />
              <img src="https://picsum.photos/seed/serial/400/520" alt="Bottle design" className="rounded-2xl shadow-xl object-cover w-full h-full" />
            </div>
          </div>
        </div>
      </div>
